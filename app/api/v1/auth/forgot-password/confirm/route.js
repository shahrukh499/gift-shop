...
export async function POST(req) {
  try {
    ...
    try {
      ...
      return NextResponse.json({ message: "Reset password link is expired." }, { status: 401 });
    }
    ...
    return NextResponse.json({ message: "Password reset successful.", status:0 }, { status: 200 });
